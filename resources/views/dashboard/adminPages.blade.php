...
@section('title', 'Published admin pages - Dashboard')
...
<section class="content dashboard">
            ...
            <div class="row">
                <div class="small-6 columns">
                    <ul class="menu page-mode-menu">
                        ...
                        <li><a href="{{ route('dashboard.savedPages') }}">Saved</a></li>
                    </ul>

                </div>
                <div class="small-6 columns">
                    <ul class="menu page-type-mode-menu float-right">
                        <li><a href="{{ route('dashboard.publishedPages') }}">Creator</a></li>
                        <li class="active"><a href="{{ route('dashboard.publishedPages.typeAdmin') }}">Admin</a></li>
                    </ul>
                </div>
            </div>

            @forelse($pages as $page)
            @include('dashboard.adminPage_row')
            @empty
    ...
    <div class="row">
        <div class="small-12 columns">
            <button class="dashboard-pages-load-more load-more" data-request-url="{{ route('dashboard.publishedPages.typeAdmin') }}" data-next-page="{{ $pages->currentPage()+1 }}" data-last-page="{{ $pages->lastPage() }}" data-left-off="{{ $pages->last()->id }}"><span class="fa fa-refresh"></span>Load more</button>
