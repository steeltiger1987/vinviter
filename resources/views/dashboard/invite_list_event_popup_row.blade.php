<div class="row">
	...
	<div class="small-4 columns float-right">
		@if($event->inviteLists->contains('id', $list->id))
		<button class="button yellow add-list-to-event-invitations" data-list-id="{{ $list->id }}" data-is-invited="1">Invited</button>
		@else
		<button class="button hollow add-list-to-event-invitations" data-list-id="{{ $list->id }}" data-is-invited="0">Invite</button>
		@endif
	</div>
</div>